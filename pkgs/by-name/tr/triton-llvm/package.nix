...
stdenv.mkDerivation (finalAttrs: {
  pname = "triton-llvm";
  # One of the tags at https://github.com/llvm/llvm-project/commit/a66376b0dc3b2ea8a84fda26faca287980986f78
  # Roughly corresponds to the 20.1.0-rc3 release. 
  # Comes from https://github.com/triton-lang/triton/blob/v3.3.0/cmake/llvm-hash.txt
  version = "20.1.0-rc3";  
